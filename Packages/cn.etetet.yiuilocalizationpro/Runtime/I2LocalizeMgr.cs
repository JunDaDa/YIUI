...
namespace I2.Loc
{
    ...
    [YIUISingleton(1100)]
    public partial class I2LocalizeMgr : YIUIMonoSingleton<I2LocalizeMgr>, IResourceManager_Bundles
    {
        [NonSerialized]
        [ReadOnly]
        ...
        private List<string> m_AllLanguage = new();
        ...
        partial void GetDefaultLanguage();

...
namespace YIUIFramework
{
    ...
    public sealed class UIDataBindImageI2 : UIDataBindSelectBase
    {
        [SerializeField]
        [ReadOnly]
        [Required("必须有此组件")]
        ...
        private async ETTask ChangeSprite(string resName)
        {
            ...
            {
                EventSystem.Instance?.YIUIInvokeEntitySync(YIUISingletonHelper.YIUIMgr, new YIUIInvokeEntity_ReleaseSprite { obj = sprite });
        ...
        private void ReleaseLastSprite()
        {
            ...
            {
                EventSystem.Instance?.YIUIInvokeEntitySync(YIUISingletonHelper.YIUIMgr, new YIUIInvokeEntity_ReleaseSprite { obj = m_LastSprite });
                m_LastSprite = null;
            }
        }
    }

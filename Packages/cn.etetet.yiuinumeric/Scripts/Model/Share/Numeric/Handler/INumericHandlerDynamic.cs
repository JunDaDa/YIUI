...
namespace ET
{
    ...
    #if ET10
    public interface INumericHandlerDynamic<T2, T3> : IEvent<T3> where T2 : Entity where T3 : struct
    #else
    ...
    [EntitySystem]
    #if ET10
    public abstract class NumericHandlerDynamicSystem<T1, T2, T3> : EventSystem<T1, T3>, INumericHandlerDynamicSystem<T1, T2, T3>
    #else
            ...
            where T1 : Entity, INumericHandlerDynamic<T2, T3> where T2 : Entity where T3 : struct
    {
        ...
        protected override void Event(T1 e, T3 t)
        {

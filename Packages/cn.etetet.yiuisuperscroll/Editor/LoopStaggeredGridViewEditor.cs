...
namespace SuperScrollView
{
    ...
    public partial class LoopStaggeredGridViewEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            OnInspectorGUIExtend(tListView);
            serializedObject.ApplyModifiedProperties();
        }

        partial void OnEnableExtend();

        partial void OnInspectorGUIExtend(LoopStaggeredGridView tListView);
    }
}

...
namespace ET.Client
{
    public partial class YIUISuperScrollStaggeredGridComponent
    {
        ...
        public int ItemStart => Owner.GetFirstShownItemIndex();
        public int ItemEnd => Owner.GetLastShownItemIndex();
    }
}
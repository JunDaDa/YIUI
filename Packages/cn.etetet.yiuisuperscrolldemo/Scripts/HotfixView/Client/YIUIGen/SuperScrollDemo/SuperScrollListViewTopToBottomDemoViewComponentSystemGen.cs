...
namespace ET.Client
{
    ...
    [EntitySystemOf(typeof(SuperScrollListViewTopToBottomDemoViewComponent))]
    public static partial class SuperScrollListViewTopToBottomDemoViewComponentSystem
    {
        [EntitySystem]
        private static void Awake(this SuperScrollListViewTopToBottomDemoViewComponent self)
        {
        }

        [EntitySystem]
        private static void YIUIBind(this SuperScrollListViewTopToBottomDemoViewComponent self)
        {
            self.UIBind();
        }

        private static void UIBind(this SuperScrollListViewTopToBottomDemoViewComponent self)
        {

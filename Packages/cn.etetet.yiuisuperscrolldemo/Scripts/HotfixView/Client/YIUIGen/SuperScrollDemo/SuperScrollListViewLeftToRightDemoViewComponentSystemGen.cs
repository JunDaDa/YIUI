...
namespace ET.Client
{
    ...
    [EntitySystemOf(typeof(SuperScrollListViewLeftToRightDemoViewComponent))]
    public static partial class SuperScrollListViewLeftToRightDemoViewComponentSystem
    {
        [EntitySystem]
        private static void Awake(this SuperScrollListViewLeftToRightDemoViewComponent self)
        {
        }

        [EntitySystem]
        private static void YIUIBind(this SuperScrollListViewLeftToRightDemoViewComponent self)
        {
            self.UIBind();
        }

        private static void UIBind(this SuperScrollListViewLeftToRightDemoViewComponent self)
        {

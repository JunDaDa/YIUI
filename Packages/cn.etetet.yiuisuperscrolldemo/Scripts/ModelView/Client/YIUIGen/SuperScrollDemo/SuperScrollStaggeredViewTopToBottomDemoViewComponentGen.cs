...
namespace ET.Client
{
    ...
    public partial class SuperScrollStaggeredViewTopToBottomDemoViewComponent : Entity, IDestroy, IAwake, IYIUIBind, IYIUIInitialize, IYIUIOpen
    {
        public const string PkgName = "SuperScrollDemo";
        public const string ResName = "SuperScrollStaggeredViewTopToBottomDemoView";
        ...
        public SuperScrollView.LoopStaggeredGridView u_ComStaggeredView;

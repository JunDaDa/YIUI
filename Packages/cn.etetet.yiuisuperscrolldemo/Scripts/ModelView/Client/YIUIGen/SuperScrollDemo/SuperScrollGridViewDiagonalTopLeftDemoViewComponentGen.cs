...
namespace ET.Client
{
    ...
    public partial class SuperScrollGridViewDiagonalTopLeftDemoViewComponent : Entity, IDestroy, IAwake, IYIUIBind, IYIUIInitialize, IYIUIOpen
    {
        public const string PkgName = "SuperScrollDemo";
        public const string ResName = "SuperScrollGridViewDiagonalTopLeftDemoView";
        ...
        public SuperScrollView.LoopGridView u_ComGridView;

...
namespace ET.Client
{
    ...
    public partial class SuperScrollDemoBackCommonComponent : Entity, IDestroy, IAwake, IYIUIBind, IYIUIInitialize
    {
        public const string PkgName = "SuperScrollDemo";
        public const string ResName = "SuperScrollDemoBackCommon";

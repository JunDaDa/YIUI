...
namespace ET.Client
{
    ...
    public partial class SuperScrollGridViewLeftToRightDemoViewComponent : Entity, IDestroy, IAwake, IYIUIBind, IYIUIInitialize, IYIUIOpen
    {
        public const string PkgName = "SuperScrollDemo";
        public const string ResName = "SuperScrollGridViewLeftToRightDemoView";

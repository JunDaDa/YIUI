...
namespace ET.Client
{
    ...
    public partial class SuperScrollListViewMultipleTopToBottomDemoViewComponent : Entity, IDestroy, IAwake, IYIUIBind, IYIUIInitialize, IYIUIOpen
    {
        public const string PkgName = "SuperScrollDemo";
        public const string ResName = "SuperScrollListViewMultipleTopToBottomDemoView";
